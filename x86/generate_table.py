...
for index, reg in enumerate(btypes.REG_8):
    gperf_file.write(f"{reg}, TOK_R8, {index}\n")

for index, reg in enumerate(btypes.REG_16):
    gperf_file.write(f"{reg}, TOK_R16, {index}\n")

for index, reg in enumerate(btypes.REG_32):
    gperf_file.write(f"{reg}, TOK_R32, {index}\n")

for index, reg in enumerate(btypes.REG_64):
    gperf_file.write(f"{reg}, TOK_R64, {index}\n")

for index, reg in enumerate(btypes.REG_XMM):
    gperf_file.write(f"{reg}, TOK_XMM, {index}\n")

for index, reg in enumerate(btypes.REG_YMM):
    gperf_file.write(f"{reg}, TOK_YMM, {index}\n")

for index, reg in enumerate(btypes.REG_ZMM):
    gperf_file.write(f"{reg}, TOK_ZMM, {index}\n")

for index, reg in enumerate(btypes.REG_MMX):
    gperf_file.write(f"{reg}, TOK_MMX, {index}\n")
