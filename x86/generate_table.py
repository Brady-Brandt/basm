...
types_h_file.write(f"#define INSTR_USES_REX {btypes.REX}\n")
types_h_file.write(f"#define INSTR_USES_2VEX {btypes.TWO_BYTE_VEX}\n")
types_h_file.write(f"#define INSTR_USES_3VEX {btypes.THREE_BYTE_VEX}\n")
...
for i, instr in enumerate(sorted_instructions):
    ...
    for instr_variant in instructions[instr]:
        ...
        gperf_file.write(instr_variant.to_c_struct() + '\n')
        current_index += 1
